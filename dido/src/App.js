...
export default function App() {
  ...
  const dsMoney = () => setBalance(balance + DE_MONEY);
  const spndMoney = () => setBalance(balance + SPEN_MONEY);
  ...
  return (
    <Page>
      ...
      */}
      ...
      <Header name="K-Bank" onClick={doLogin} />
          ...
          config={[
            {
              name: "Зняти баланс",
              onClick: dsMoney,
              img: "/icon/moneycash.svg"
            },
            {
              name: "Поповнити баланс",
              onClick: getMoney,
              img: "/icon/moneyearn.svg"
            },
            {
              name: "Придбати щось",
              onClick: spndMoney,
              img: "/icon/moneycard.svg"
            }
          ]}
        />
      )}
